@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 02_M01__FUNDAMENTAL_AI__02_ai_lifecycle_etika.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 01 - FUNDAMENTAL AI | 02_ai_lifecycle_etika.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_01_fundamental_ai\02_ai_lifecycle_etika.py
echo ======================================================================
echo.
...
echo    python "modul_01_fundamental_ai\02_ai_lifecycle_etika.py"
echo.
python "modul_01_fundamental_ai\02_ai_lifecycle_etika.py"
