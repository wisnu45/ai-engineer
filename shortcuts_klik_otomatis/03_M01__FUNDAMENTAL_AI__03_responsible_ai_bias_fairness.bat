@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 03_M01__FUNDAMENTAL_AI__03_responsible_ai_bias_fairness.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 01 - FUNDAMENTAL AI | 03_responsible_ai_bias_fairness.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_01_fundamental_ai\03_responsible_ai_bias_fairness.py
echo ======================================================================
echo.
...
echo    python "modul_01_fundamental_ai\03_responsible_ai_bias_fairness.py"
echo.
python "modul_01_fundamental_ai\03_responsible_ai_bias_fairness.py"
