@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 19_M08__NLP__01_text_preprocessing_tfidf_sentiment.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 08 - NLP | 01_text_preprocessing_tfidf_sentiment.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_08_nlp\01_text_preprocessing_tfidf_sentiment.py
echo ======================================================================
echo.
...
echo    python "modul_08_nlp\01_text_preprocessing_tfidf_sentiment.py"
echo.
python "modul_08_nlp\01_text_preprocessing_tfidf_sentiment.py"
