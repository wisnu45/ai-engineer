@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 22_M11__PROYEK_E2E__01_proyek_e2e_harga_rumah_portfolio.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 11 - PROYEK E2E | 01_proyek_e2e_harga_rumah_portfolio.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_11_proyek_end_to_end\01_proyek_e2e_harga_rumah_portfolio.py
echo ======================================================================
echo.
...
echo    python "modul_11_proyek_end_to_end\01_proyek_e2e_harga_rumah_portfolio.py"
echo.
python "modul_11_proyek_end_to_end\01_proyek_e2e_harga_rumah_portfolio.py"
