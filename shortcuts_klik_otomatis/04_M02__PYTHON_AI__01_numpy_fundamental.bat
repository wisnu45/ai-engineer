@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 04_M02__PYTHON_AI__01_numpy_fundamental.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 02 - PYTHON AI | 01_numpy_fundamental.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_02_python_ai\01_numpy_fundamental.py
echo ======================================================================
echo.
...
echo.
python "modul_02_python_ai\01_numpy_fundamental.py"
