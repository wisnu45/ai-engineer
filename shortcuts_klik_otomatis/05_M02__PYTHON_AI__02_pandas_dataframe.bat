@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 05_M02__PYTHON_AI__02_pandas_dataframe.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 02 - PYTHON AI | 02_pandas_dataframe.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_02_python_ai\02_pandas_dataframe.py
echo ======================================================================
echo.
...
echo    python "modul_02_python_ai\02_pandas_dataframe.py"
echo.
python "modul_02_python_ai\02_pandas_dataframe.py"
