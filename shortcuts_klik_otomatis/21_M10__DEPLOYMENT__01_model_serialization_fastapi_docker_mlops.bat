@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 21_M10__DEPLOYMENT__01_model_serialization_fastapi_docker_mlops.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 10 - DEPLOYMENT | 01_model_serialization_fastapi_docker_mlops.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_10_deployment\01_model_serialization_fastapi_docker_mlops.py
echo ======================================================================
echo.
...
echo.
python "modul_10_deployment\01_model_serialization_fastapi_docker_mlops.py"
