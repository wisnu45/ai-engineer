@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 15_M05__EVALUASI_&_TUNING__02_cross_validation_tuning_grid_random_search.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 05 - EVALUASI & TUNING | 02_cross_validation_tuning_grid_random_search.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_05_ml_evaluation_tuning\02_cross_validation_tuning_grid_random_search.py
echo ======================================================================
echo.
...
echo    python "modul_05_ml_evaluation_tuning\02_cross_validation_tuning_grid_random_search.py"
echo.
python "modul_05_ml_evaluation_tuning\02_cross_validation_tuning_grid_random_search.py"
