@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 01_M01__FUNDAMENTAL_AI__01_konsep_dasar_ai.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 01 - FUNDAMENTAL AI | 01_konsep_dasar_ai.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_01_fundamental_ai\01_konsep_dasar_ai.py
echo ======================================================================
echo.
...
echo    python "modul_01_fundamental_ai\01_konsep_dasar_ai.py"
echo.
python "modul_01_fundamental_ai\01_konsep_dasar_ai.py"
