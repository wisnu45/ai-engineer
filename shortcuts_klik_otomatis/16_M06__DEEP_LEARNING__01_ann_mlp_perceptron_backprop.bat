@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 16_M06__DEEP_LEARNING__01_ann_mlp_perceptron_backprop.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 06 - DEEP LEARNING | 01_ann_mlp_perceptron_backprop.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_06_deep_learning\01_ann_mlp_perceptron_backprop.py
echo ======================================================================
echo.
...
echo    python "modul_06_deep_learning\01_ann_mlp_perceptron_backprop.py"
echo.
python "modul_06_deep_learning\01_ann_mlp_perceptron_backprop.py"
