@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 13_M04__MACHINE_LEARNING__03_clustering_kmeans_dbscan_hierarchical.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 04 - MACHINE LEARNING | 03_clustering_kmeans_dbscan_hierarchical.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_04_machine_learning\03_clustering_kmeans_dbscan_hierarchical.py
echo ======================================================================
echo.
...
echo    python "modul_04_machine_learning\03_clustering_kmeans_dbscan_hierarchical.py"
echo.
python "modul_04_machine_learning\03_clustering_kmeans_dbscan_hierarchical.py"
