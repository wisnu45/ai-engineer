@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 17_M06__DEEP_LEARNING__02_cnn_classification_mnist.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 06 - DEEP LEARNING | 02_cnn_classification_mnist.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_06_deep_learning\02_cnn_classification_mnist.py
echo ======================================================================
echo.
...
echo    python "modul_06_deep_learning\02_cnn_classification_mnist.py"
echo.
python "modul_06_deep_learning\02_cnn_classification_mnist.py"
