@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 23_M12__PERSIAPAN_BNSP__01_simulasi_asesmen_checklist_soal_bnsp.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 12 - PERSIAPAN BNSP | 01_simulasi_asesmen_checklist_soal_bnsp.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_12_persiapan_bnsp\01_simulasi_asesmen_checklist_soal_bnsp.py
echo ======================================================================
echo.
...
echo    python "modul_12_persiapan_bnsp\01_simulasi_asesmen_checklist_soal_bnsp.py"
echo.
python "modul_12_persiapan_bnsp\01_simulasi_asesmen_checklist_soal_bnsp.py"
