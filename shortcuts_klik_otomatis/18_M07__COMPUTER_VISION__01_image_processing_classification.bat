@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 18_M07__COMPUTER_VISION__01_image_processing_classification.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 07 - COMPUTER VISION | 01_image_processing_classification.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_07_computer_vision\01_image_processing_classification.py
echo ======================================================================
echo.
...
echo    python "modul_07_computer_vision\01_image_processing_classification.py"
echo.
python "modul_07_computer_vision\01_image_processing_classification.py"
