@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 12_M04__MACHINE_LEARNING__02_regresi_linreg_ridge_lasso_gbm.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 04 - MACHINE LEARNING | 02_regresi_linreg_ridge_lasso_gbm.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_04_machine_learning\02_regresi_linreg_ridge_lasso_gbm.py
echo ======================================================================
echo.
...
echo    python "modul_04_machine_learning\02_regresi_linreg_ridge_lasso_gbm.py"
echo.
python "modul_04_machine_learning\02_regresi_linreg_ridge_lasso_gbm.py"
