@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 20_M09__GENERATIVE_AI__01_generative_ai_llm_prompt_engineering_rag.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 09 - GENERATIVE AI | 01_generative_ai_llm_prompt_engineering_rag.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_09_generative_ai\01_generative_ai_llm_prompt_engineering_rag.py
echo ======================================================================
echo.
...
echo    python "modul_09_generative_ai\01_generative_ai_llm_prompt_engineering_rag.py"
echo.
python "modul_09_generative_ai\01_generative_ai_llm_prompt_engineering_rag.py"
