@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 08_M03__DATA_PREPARATION__01_data_understanding_cleaning.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 03 - DATA PREPARATION | 01_data_understanding_cleaning.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_03_data_prep\01_data_understanding_cleaning.py
echo ======================================================================
echo.
...
echo.
python "modul_03_data_prep\01_data_understanding_cleaning.py"
