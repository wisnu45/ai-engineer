@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 24_M10_DEPLOYMENT__RUN_FASTAPI_CHURN_8000.bat
...
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: fastapi_churn_app_TEMPLATE:app --host 0.0.0.0 --port 8000 --reload
echo ======================================================================
echo.

REM Step 1: Masuk ke folder project
cd /d c:\ai-engineer\modul_10_deployment
...
echo    python "fastapi_churn_app_TEMPLATE:app --host 0.0.0.0 --port 8000 --reload"
echo.
python -m uvicorn "fastapi_churn_app_TEMPLATE:app --host 0.0.0.0 --port 8000 --reload"
