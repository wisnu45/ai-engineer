@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 11_M04__MACHINE_LEARNING__01_klasifikasi_logreg_svm_dt_rf.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 04 - MACHINE LEARNING | 01_klasifikasi_logreg_svm_dt_rf.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_04_machine_learning\01_klasifikasi_logreg_svm_dt_rf.py
echo ======================================================================
echo.
...
echo    python "modul_04_machine_learning\01_klasifikasi_logreg_svm_dt_rf.py"
echo.
python "modul_04_machine_learning\01_klasifikasi_logreg_svm_dt_rf.py"
