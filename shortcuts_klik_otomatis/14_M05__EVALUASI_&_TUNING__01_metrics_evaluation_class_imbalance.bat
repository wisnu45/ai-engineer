@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 14_M05__EVALUASI_&_TUNING__01_metrics_evaluation_class_imbalance.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 05 - EVALUASI & TUNING | 01_metrics_evaluation_class_imbalance.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_05_ml_evaluation_tuning\01_metrics_evaluation_class_imbalance.py
echo ======================================================================
echo.
...
echo    python "modul_05_ml_evaluation_tuning\01_metrics_evaluation_class_imbalance.py"
echo.
python "modul_05_ml_evaluation_tuning\01_metrics_evaluation_class_imbalance.py"
