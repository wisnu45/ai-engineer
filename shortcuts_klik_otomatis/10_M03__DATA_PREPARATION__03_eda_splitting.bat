@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 10_M03__DATA_PREPARATION__03_eda_splitting.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 03 - DATA PREPARATION | 03_eda_splitting.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_03_data_prep\03_eda_splitting.py
echo ======================================================================
echo.
...
echo    python "modul_03_data_prep\03_eda_splitting.py"
echo.
python "modul_03_data_prep\03_eda_splitting.py"
