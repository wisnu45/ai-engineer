@echo off
REM ============================================================
REM SHORTCUT AUTO RUN: 09_M03__DATA_PREPARATION__02_transformation_encoding_scaling.bat
REM DI-GENERATE OTOMATIS — TINGGAL DOUBLE KLIK .BAT INI!
REM ============================================================
chcp 65001 >nul
set PYTHONUTF8=1
set PYTHONIOENCODING=utf-8
title MODUL 03 - DATA PREPARATION | 02_transformation_encoding_scaling.py
echo.
echo ======================================================================
echo  🚀 MENJALANKAN SCRIPT: modul_03_data_prep\02_transformation_encoding_scaling.py
echo ======================================================================
echo.
...
echo    python "modul_03_data_prep\02_transformation_encoding_scaling.py"
echo.
python "modul_03_data_prep\02_transformation_encoding_scaling.py"
